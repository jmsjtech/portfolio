...
pub fn draw_ui(ecs: &World, ctx : &mut Rltk) {
    ...
    if let Some(clock) = clock {
        ...
        if season == "SPR" { draw_batch.print_color( Point::new(61, 44), &format!("{} {}, Y {}", season, days, clock.year), ColorPair::new(RGB::named(rltk::SPRINGGREEN), RGB::named(rltk::BLACK))); }
        if season == "SUM" { draw_batch.print_color( Point::new(61, 44), &format!("{} {}, Y {}", season, days, clock.year), ColorPair::new(RGB::named(rltk::GOLD), RGB::named(rltk::BLACK)));}
        if season == "AUT" { draw_batch.print_color( Point::new(61, 44), &format!("{} {}, Y {}", season, days, clock.year), ColorPair::new(RGB::named(rltk::ORANGE_RED), RGB::named(rltk::BLACK))); }
        if season == "WIN" { draw_batch.print_color( Point::new(61, 44), &format!("{} {}, Y {}", season, days, clock.year), ColorPair::new(RGB::named(rltk::CORNFLOWERBLUE), RGB::named(rltk::BLACK)));}
