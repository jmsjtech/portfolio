use specs::prelude::*;
use super::{Viewshed, Monster, LastActed, Position, Map, WantsToMelee};
use rltk::Point;
...
impl<'a> System<'a> for MonsterAI {
    ...
    fn run(&mut self, data : Self::SystemData) {
        let (mut map, player_pos, player_entity, entities, mut viewshed, monster, mut position, mut wants_to_melee, mut lastacted) = data;
