...
namespace Jawara.UI {
    ...
    public class UIManager : ContainerConsole {
        ...
        private void CheckKeyboard() {
            ...
            if (SadConsole.Global.KeyboardState.IsKeyPressed(Keys.Up) || SadConsole.Global.KeyboardState.IsKeyPressed(Keys.NumPad8)) {
            ...
            if (SadConsole.Global.KeyboardState.IsKeyPressed(Keys.Down) || SadConsole.Global.KeyboardState.IsKeyPressed(Keys.NumPad2)) {
                GameLoop.CommandManager.MoveActorBy(GameLoop.World.Player, new Point(0, 1));
                CenterOnActor(GameLoop.World.Player);
            }
            ...
            if (SadConsole.Global.KeyboardState.IsKeyPressed(Keys.Left) || SadConsole.Global.KeyboardState.IsKeyPressed(Keys.NumPad4)) {
            ...
            if (SadConsole.Global.KeyboardState.IsKeyPressed(Keys.Right) || SadConsole.Global.KeyboardState.IsKeyPressed(Keys.NumPad6)) {
                GameLoop.CommandManager.MoveActorBy(GameLoop.World.Player, new Point(1, 0));
                CenterOnActor(GameLoop.World.Player);
            }
