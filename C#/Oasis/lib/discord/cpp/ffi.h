...
class IDiscordLobbyTransaction {
    enum EDiscordResult (*set_type)(class IDiscordLobbyTransaction* lobby_transaction,
                                    enum EDiscordLobbyType type);
    enum EDiscordResult (*set_owner)(class IDiscordLobbyTransaction* lobby_transaction,
                                     DiscordUserId owner_id);
    enum EDiscordResult (*set_capacity)(class IDiscordLobbyTransaction* lobby_transaction,
                                        uint32_t capacity);
    enum EDiscordResult (*set_metadata)(class IDiscordLobbyTransaction* lobby_transaction,
                                        DiscordMetadataKey key,
                                        DiscordMetadataValue value);
    enum EDiscordResult (*delete_metadata)(class IDiscordLobbyTransaction* lobby_transaction,
                                           DiscordMetadataKey key);
    enum EDiscordResult (*set_locked)(class IDiscordLobbyTransaction* lobby_transaction,
                                      bool locked);
};

class IDiscordLobbyMemberTransaction {
    enum EDiscordResult (*set_metadata)(
      class IDiscordLobbyMemberTransaction* lobby_member_transaction,
      DiscordMetadataKey key,
      DiscordMetadataValue value);
...
class IDiscordLobbySearchQuery {
    enum EDiscordResult (*filter)(class IDiscordLobbySearchQuery* lobby_search_query,
                                  DiscordMetadataKey key,
                                  enum EDiscordLobbySearchComparison comparison,
                                  enum EDiscordLobbySearchCast cast,
                                  DiscordMetadataValue value);
    enum EDiscordResult (*sort)(class IDiscordLobbySearchQuery* lobby_search_query,
                                DiscordMetadataKey key,
                                enum EDiscordLobbySearchCast cast,
                                DiscordMetadataValue value);
    enum EDiscordResult (*limit)(class IDiscordLobbySearchQuery* lobby_search_query,
                                 uint32_t limit);
    enum EDiscordResult (*distance)(class IDiscordLobbySearchQuery* lobby_search_query,
...
class IDiscordApplicationManager {
    void (*validate_or_exit)(class IDiscordApplicationManager* manager,
                             void* callback_data,
    ...
    void (*get_oauth2_token)(class IDiscordApplicationManager* manager,
                             void* callback_data,
                             void (*callback)(void* callback_data,
                                              enum EDiscordResult result,
                                              class DiscordOAuth2Token* oauth2_token));
    void (*get_ticket)(class IDiscordApplicationManager* manager,
                       void* callback_data,
                       void (*callback)(void* callback_data,
                                        enum EDiscordResult result,
                                        const char* data));
...
class IDiscordUserManager {
    enum EDiscordResult (*get_current_user)(class IDiscordUserManager* manager,
                                            class DiscordUser* current_user);
    void (*get_user)(class IDiscordUserManager* manager,
                     DiscordUserId user_id,
                     void* callback_data,
                     void (*callback)(void* callback_data,
                                      enum EDiscordResult result,
                                      class DiscordUser* user));
    enum EDiscordResult (*get_current_user_premium_type)(class IDiscordUserManager* manager,
                                                         enum EDiscordPremiumType* premium_type);
    enum EDiscordResult (*current_user_has_flag)(class IDiscordUserManager* manager,
...
class IDiscordImageManager {
    void (*fetch)(class IDiscordImageManager* manager,
                  class DiscordImageHandle handle,
                  bool refresh,
                  void* callback_data,
                  void (*callback)(void* callback_data,
                                   enum EDiscordResult result,
                                   class DiscordImageHandle handle_result));
    enum EDiscordResult (*get_dimensions)(class IDiscordImageManager* manager,
                                          class DiscordImageHandle handle,
                                          class DiscordImageDimensions* dimensions);
    enum EDiscordResult (*get_data)(class IDiscordImageManager* manager,
                                    class DiscordImageHandle handle,
                                    uint8_t* data,
...
class IDiscordActivityManager {
    enum EDiscordResult (*register_command)(class IDiscordActivityManager* manager,
                                            const char* command);
    enum EDiscordResult (*register_steam)(class IDiscordActivityManager* manager,
                                          uint32_t steam_id);
    void (*update_activity)(class IDiscordActivityManager* manager,
                            class DiscordActivity* activity,
                            void* callback_data,
                            void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*clear_activity)(class IDiscordActivityManager* manager,
                           void* callback_data,
                           void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*send_request_reply)(class IDiscordActivityManager* manager,
                               DiscordUserId user_id,
                               enum EDiscordActivityJoinRequestReply reply,
                               void* callback_data,
                               void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*send_invite)(class IDiscordActivityManager* manager,
                        DiscordUserId user_id,
                        enum EDiscordActivityActionType type,
                        const char* content,
                        void* callback_data,
                        void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*accept_invite)(class IDiscordActivityManager* manager,
                          DiscordUserId user_id,
                          void* callback_data,
                          void (*callback)(void* callback_data, enum EDiscordResult result));
};
...
class IDiscordRelationshipManager {
    void (*filter)(class IDiscordRelationshipManager* manager,
                   void* filter_data,
                   bool (*filter)(void* filter_data, class DiscordRelationship* relationship));
    enum EDiscordResult (*count)(class IDiscordRelationshipManager* manager, int32_t* count);
    enum EDiscordResult (*get)(class IDiscordRelationshipManager* manager,
                               DiscordUserId user_id,
                               class DiscordRelationship* relationship);
    enum EDiscordResult (*get_at)(class IDiscordRelationshipManager* manager,
                                  uint32_t index,
                                  class DiscordRelationship* relationship);
};
...
class IDiscordLobbyManager {
    enum EDiscordResult (*get_lobby_create_transaction)(
      class IDiscordLobbyManager* manager,
      class IDiscordLobbyTransaction** transaction);
    ...
    enum EDiscordResult (*get_member_update_transaction)(
      ...
      DiscordLobbyId lobby_id,
      DiscordUserId user_id,
      class IDiscordLobbyMemberTransaction** transaction);
    void (*create_lobby)(class IDiscordLobbyManager* manager,
                         class IDiscordLobbyTransaction* transaction,
                         void* callback_data,
                         void (*callback)(void* callback_data,
                                          enum EDiscordResult result,
                                          class DiscordLobby* lobby));
    void (*update_lobby)(class IDiscordLobbyManager* manager,
                         DiscordLobbyId lobby_id,
                         class IDiscordLobbyTransaction* transaction,
                         void* callback_data,
                         void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*delete_lobby)(class IDiscordLobbyManager* manager,
                         DiscordLobbyId lobby_id,
                         void* callback_data,
                         void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*connect_lobby)(class IDiscordLobbyManager* manager,
                          DiscordLobbyId lobby_id,
                          DiscordLobbySecret secret,
                          void* callback_data,
                          void (*callback)(void* callback_data,
                                           enum EDiscordResult result,
                                           class DiscordLobby* lobby));
    void (*connect_lobby_with_activity_secret)(class IDiscordLobbyManager* manager,
                                               DiscordLobbySecret activity_secret,
                                               void* callback_data,
                                               void (*callback)(void* callback_data,
                                                                enum EDiscordResult result,
                                                                class DiscordLobby* lobby));
    void (*disconnect_lobby)(class IDiscordLobbyManager* manager,
                             DiscordLobbyId lobby_id,
                             void* callback_data,
                             void (*callback)(void* callback_data, enum EDiscordResult result));
    enum EDiscordResult (*get_lobby)(class IDiscordLobbyManager* manager,
                                     DiscordLobbyId lobby_id,
                                     class DiscordLobby* lobby);
    enum EDiscordResult (*get_lobby_activity_secret)(class IDiscordLobbyManager* manager,
                                                     DiscordLobbyId lobby_id,
                                                     DiscordLobbySecret* secret);
    enum EDiscordResult (*get_lobby_metadata_value)(class IDiscordLobbyManager* manager,
                                                    DiscordLobbyId lobby_id,
                                                    DiscordMetadataKey key,
                                                    DiscordMetadataValue* value);
    enum EDiscordResult (*get_lobby_metadata_key)(class IDiscordLobbyManager* manager,
                                                  DiscordLobbyId lobby_id,
                                                  int32_t index,
                                                  DiscordMetadataKey* key);
    enum EDiscordResult (*lobby_metadata_count)(class IDiscordLobbyManager* manager,
                                                DiscordLobbyId lobby_id,
                                                int32_t* count);
    enum EDiscordResult (*member_count)(class IDiscordLobbyManager* manager,
                                        DiscordLobbyId lobby_id,
                                        int32_t* count);
    enum EDiscordResult (*get_member_user_id)(class IDiscordLobbyManager* manager,
                                              DiscordLobbyId lobby_id,
                                              int32_t index,
                                              DiscordUserId* user_id);
    enum EDiscordResult (*get_member_user)(class IDiscordLobbyManager* manager,
                                           DiscordLobbyId lobby_id,
                                           DiscordUserId user_id,
                                           class DiscordUser* user);
    enum EDiscordResult (*get_member_metadata_value)(class IDiscordLobbyManager* manager,
                                                     DiscordLobbyId lobby_id,
                                                     DiscordUserId user_id,
                                                     DiscordMetadataKey key,
                                                     DiscordMetadataValue* value);
    enum EDiscordResult (*get_member_metadata_key)(class IDiscordLobbyManager* manager,
                                                   DiscordLobbyId lobby_id,
                                                   DiscordUserId user_id,
                                                   int32_t index,
                                                   DiscordMetadataKey* key);
    enum EDiscordResult (*member_metadata_count)(class IDiscordLobbyManager* manager,
                                                 DiscordLobbyId lobby_id,
                                                 DiscordUserId user_id,
                                                 int32_t* count);
    void (*update_member)(class IDiscordLobbyManager* manager,
                          DiscordLobbyId lobby_id,
                          DiscordUserId user_id,
                          class IDiscordLobbyMemberTransaction* transaction,
                          void* callback_data,
                          void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*send_lobby_message)(class IDiscordLobbyManager* manager,
                               DiscordLobbyId lobby_id,
                               uint8_t* data,
                               uint32_t data_length,
                               void* callback_data,
                               void (*callback)(void* callback_data, enum EDiscordResult result));
    enum EDiscordResult (*get_search_query)(class IDiscordLobbyManager* manager,
                                            class IDiscordLobbySearchQuery** query);
    void (*search)(class IDiscordLobbyManager* manager,
                   class IDiscordLobbySearchQuery* query,
                   void* callback_data,
                   void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*lobby_count)(class IDiscordLobbyManager* manager, int32_t* count);
    enum EDiscordResult (*get_lobby_id)(class IDiscordLobbyManager* manager,
                                        int32_t index,
                                        DiscordLobbyId* lobby_id);
    void (*connect_voice)(class IDiscordLobbyManager* manager,
                          DiscordLobbyId lobby_id,
                          void* callback_data,
                          void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*disconnect_voice)(class IDiscordLobbyManager* manager,
                             DiscordLobbyId lobby_id,
                             void* callback_data,
                             void (*callback)(void* callback_data, enum EDiscordResult result));
    enum EDiscordResult (*connect_network)(class IDiscordLobbyManager* manager,
                                           DiscordLobbyId lobby_id);
    enum EDiscordResult (*disconnect_network)(class IDiscordLobbyManager* manager,
                                              DiscordLobbyId lobby_id);
    enum EDiscordResult (*flush_network)(class IDiscordLobbyManager* manager);
    enum EDiscordResult (*open_network_channel)(class IDiscordLobbyManager* manager,
                                                DiscordLobbyId lobby_id,
                                                uint8_t channel_id,
                                                bool reliable);
    enum EDiscordResult (*send_network_message)(class IDiscordLobbyManager* manager,
                                                DiscordLobbyId lobby_id,
                                                DiscordUserId user_id,
                                                uint8_t channel_id,
                                                uint8_t* data,
...
class IDiscordNetworkManager {
     ...
     */
    enum EDiscordResult (*open_peer)(class IDiscordNetworkManager* manager,
                                     DiscordNetworkPeerId peer_id,
                                     const char* route_data);
    /**
     * Update the route data for a connected peer.
     */
    enum EDiscordResult (*update_peer)(class IDiscordNetworkManager* manager,
                                       DiscordNetworkPeerId peer_id,
                                       const char* route_data);
    /**
     * Close the connection to a remote peer.
     */
    enum EDiscordResult (*close_peer)(class IDiscordNetworkManager* manager,
                                      DiscordNetworkPeerId peer_id);
    /**
     * Open a message channel to a connected peer.
     */
    enum EDiscordResult (*open_channel)(class IDiscordNetworkManager* manager,
                                        DiscordNetworkPeerId peer_id,
                                        DiscordNetworkChannelId channel_id,
                                        bool reliable);
    /**
     ...
     */
    enum EDiscordResult (*close_channel)(class IDiscordNetworkManager* manager,
                                         DiscordNetworkPeerId peer_id,
                                         DiscordNetworkChannelId channel_id);
    /**
     * Send a message to a connected peer over an opened message channel.
     */
    enum EDiscordResult (*send_message)(class IDiscordNetworkManager* manager,
                                        DiscordNetworkPeerId peer_id,
                                        DiscordNetworkChannelId channel_id,
                                        uint8_t* data,
                                        uint32_t data_length);
...
class IDiscordOverlayManager {
    ...
    void (*set_locked)(class IDiscordOverlayManager* manager,
                       bool locked,
                       void* callback_data,
                       void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*open_activity_invite)(class IDiscordOverlayManager* manager,
                                 enum EDiscordActivityActionType type,
                                 void* callback_data,
                                 void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*open_guild_invite)(class IDiscordOverlayManager* manager,
                              const char* code,
                              void* callback_data,
                              void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*open_voice_settings)(class IDiscordOverlayManager* manager,
                                void* callback_data,
                                void (*callback)(void* callback_data, enum EDiscordResult result));
};
...
class IDiscordStorageManager {
    enum EDiscordResult (*read)(class IDiscordStorageManager* manager,
                                const char* name,
                                uint8_t* data,
                                uint32_t data_length,
                                uint32_t* read);
    void (*read_async)(class IDiscordStorageManager* manager,
                       const char* name,
                       void* callback_data,
                       void (*callback)(void* callback_data,
                                        enum EDiscordResult result,
                                        uint8_t* data,
                                        uint32_t data_length));
    void (*read_async_partial)(class IDiscordStorageManager* manager,
                               const char* name,
                               uint64_t offset,
                               uint64_t length,
                               void* callback_data,
                               void (*callback)(void* callback_data,
                                                ...
                                                uint8_t* data,
                                                uint32_t data_length));
    enum EDiscordResult (*write)(class IDiscordStorageManager* manager,
                                 const char* name,
                                 uint8_t* data,
                                 uint32_t data_length);
    void (*write_async)(class IDiscordStorageManager* manager,
                        const char* name,
                        uint8_t* data,
                        uint32_t data_length,
                        void* callback_data,
    ...
    enum EDiscordResult (*exists)(class IDiscordStorageManager* manager,
                                  const char* name,
                                  bool* exists);
    void (*count)(class IDiscordStorageManager* manager, int32_t* count);
    enum EDiscordResult (*stat)(class IDiscordStorageManager* manager,
                                const char* name,
                                class DiscordFileStat* stat);
    enum EDiscordResult (*stat_at)(class IDiscordStorageManager* manager,
                                   int32_t index,
                                   class DiscordFileStat* stat);
...
class IDiscordStoreManager {
    void (*fetch_skus)(class IDiscordStoreManager* manager,
                       void* callback_data,
                       void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*count_skus)(class IDiscordStoreManager* manager, int32_t* count);
    enum EDiscordResult (*get_sku)(class IDiscordStoreManager* manager,
                                   DiscordSnowflake sku_id,
                                   class DiscordSku* sku);
    enum EDiscordResult (*get_sku_at)(class IDiscordStoreManager* manager,
                                      int32_t index,
                                      class DiscordSku* sku);
    void (*fetch_entitlements)(class IDiscordStoreManager* manager,
                               void* callback_data,
                               void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*count_entitlements)(class IDiscordStoreManager* manager, int32_t* count);
    enum EDiscordResult (*get_entitlement)(class IDiscordStoreManager* manager,
                                           DiscordSnowflake entitlement_id,
                                           class DiscordEntitlement* entitlement);
    enum EDiscordResult (*get_entitlement_at)(class IDiscordStoreManager* manager,
                                              int32_t index,
                                              class DiscordEntitlement* entitlement);
    enum EDiscordResult (*has_sku_entitlement)(class IDiscordStoreManager* manager,
                                               DiscordSnowflake sku_id,
                                               bool* has_entitlement);
    void (*start_purchase)(class IDiscordStoreManager* manager,
                           DiscordSnowflake sku_id,
                           void* callback_data,
                           void (*callback)(void* callback_data, enum EDiscordResult result));
};
...
class IDiscordVoiceManager {
    enum EDiscordResult (*get_input_mode)(class IDiscordVoiceManager* manager,
                                          class DiscordInputMode* input_mode);
    void (*set_input_mode)(class IDiscordVoiceManager* manager,
                           class DiscordInputMode input_mode,
                           void* callback_data,
                           void (*callback)(void* callback_data, enum EDiscordResult result));
    ...
    enum EDiscordResult (*is_local_mute)(class IDiscordVoiceManager* manager,
                                         DiscordSnowflake user_id,
                                         bool* mute);
    enum EDiscordResult (*set_local_mute)(class IDiscordVoiceManager* manager,
                                          DiscordSnowflake user_id,
                                          bool mute);
    enum EDiscordResult (*get_local_volume)(class IDiscordVoiceManager* manager,
                                            DiscordSnowflake user_id,
                                            uint8_t* volume);
    enum EDiscordResult (*set_local_volume)(class IDiscordVoiceManager* manager,
                                            DiscordSnowflake user_id,
                                            uint8_t volume);
};
...
class IDiscordAchievementEvents {
    void (*on_user_achievement_update)(void* event_data,
                                       class DiscordUserAchievement* user_achievement);
};

class IDiscordAchievementManager {
    void (*set_user_achievement)(class IDiscordAchievementManager* manager,
                                 DiscordSnowflake achievement_id,
                                 uint8_t percent_complete,
                                 void* callback_data,
                                 void (*callback)(void* callback_data, enum EDiscordResult result));
    void (*fetch_user_achievements)(class IDiscordAchievementManager* manager,
                                    void* callback_data,
                                    void (*callback)(void* callback_data,
                                                     enum EDiscordResult result));
    void (*count_user_achievements)(class IDiscordAchievementManager* manager, int32_t* count);
    enum EDiscordResult (*get_user_achievement)(class IDiscordAchievementManager* manager,
                                                DiscordSnowflake user_achievement_id,
                                                class DiscordUserAchievement* user_achievement);
    enum EDiscordResult (*get_user_achievement_at)(class IDiscordAchievementManager* manager,
                                                   int32_t index,
                                                   class DiscordUserAchievement* user_achievement);
};
...
class IDiscordCore {
    ...
    void (*set_log_hook)(class IDiscordCore* core,
...
#endif
  void
  DiscordCreateParamsSetDefault(class DiscordCreateParams* params)
{
...
enum EDiscordResult DiscordCreate(DiscordVersion version,
                                  class DiscordCreateParams* params,
                                  class IDiscordCore** result);
